...
namespace fasttext {
//Defined moe Model Name
enum class model_name : int { cbow = 1, sg, sup, moe };
// Defined Moe Loss Name
enum class loss_name : int { hs = 1, ns, softmax, ova, moeLoss };
...
class Args {
 ...
 public:
  ...
  std::string input;
  std::string output;
  //Attribute for Misspelled Data File
  std::string misspelledData;
  ...
  // defining bucket for misspelled Words
  int missBucket;
